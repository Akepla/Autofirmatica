...
[[<terrafirmacraft:item.Black Steel Sheet>,<terrafirmacraft:FireBrick>,<terrafirmacraft:item.Black Steel Sheet>],
[<terrafirmacraft:FireBrick>,null,<terrafirmacraft:FireBrick>],
[<terrafirmacraft:item.Black Steel Sheet>,<terrafirmacraft:FireBrick>,<terrafirmacraft:item.Black Steel Sheet>]]);
...
[[<terrafirmacraft:item.Brass Sheet>,<ore:plankTreatedWood>,<terrafirmacraft:item.Brass Sheet>],
[<ore:plankTreatedWood>,<ore:nuggetSteel>,<ore:plankTreatedWood>],
[<terrafirmacraft:item.Brass Sheet>,<ore:plankTreatedWood>,<terrafirmacraft:item.Brass Sheet>]]);
//recipes for wooden crate

recipes.remove(<minecraft:coal>);
recipes.remove(<ImmersiveEngineering:tool>);
recipes.addShaped(<ImmersiveEngineering:tool>, 
[[null,<ore:ingotIron>,<ore:materialString>],
[null,<ore:treatedStick>,<ore:ingotIron>],
...
mods.immersiveengineering.MetalPress.removeRecipe(<terrafirmacraft:item.Copper Sheet>);
...
mods.immersiveengineering.MetalPress.removeRecipe(<terrafirmacraft:item.Steel Sheet>);
mods.immersiveengineering.MetalPress.removeRecipe(<terrafirmacraft:item.Brass Sheet>);
mods.immersiveengineering.MetalPress.removeRecipe(<terrafirmacraft:item.Lead Sheet>);
mods.immersiveengineering.MetalPress.removeRecipe(<terrafirmacraft:item.Nickel Sheet>);
...
mods.immersiveengineering.MetalPress.removeRecipe(<terrafirmacraft:item.Silver Sheet>);
